...
function Sidebar() {
  ...
  return (
    ...
    <div className="text-gray-500 p-5 text-xs lg:text-sm border-gray-900 overflow-y-scroll scrollbar-hide h-screen sm:max-w-[12rem] lg:max-w-[15rem] hidden md:inline-flex pb-36">
      <div className="space-y-2">
        ...
        <button className="flex items-center space-x-2 hover:text-white text-blue-700">
